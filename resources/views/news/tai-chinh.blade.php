...
@section('content')
    ...
    <section class="wrap-news-page">
        <div class="container">
            <h3 class="title-block">Tin tức tài chính</h3>
            <div class="news-content row">
                <div class="col-md-9">
                    <ul class="list-item-horizontal-news">
                        @foreach($data['data'] as $item)
                        <li class="item">
                            <a href="{{ route('finance.detail', $item['id']) }}">
                ...
                <div class="col-md-3 no-padding-left">
                    <div class="wrap-box">
                        ...
                        <a href="#" class="banner-box">
                            <img src="{{ asset('html/assets/images/banner-box2.png') }}" alt="">
                        </a>
                    </div>
                </div>
            </div>
